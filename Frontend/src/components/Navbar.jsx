...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl container mx-auto md:px-20  px-4 dark:bg-slate-900 dark:text-white fixed left-0 right-0 top-0 z-50 bg-white ${sticky ? "sticky-navbar shadow-md dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out" : ""
                }`}>
