...
const navItems=(<>
  ...
  return (
    <>
    <div className={`max-w-screen-2xl container mx-auto md:px-20  px-4 dark:bg-slate-900 dark:text-white fixed left-0 right-0 top-0 z-50 bg-white ${

        sticky?"sticky-navbar shadow-md dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out": ""
    }`}>
    <div className="navbar">
        ...
        <div className="navbar-end space-x-3">
            ...
            <div>
                <a className="bg-black text-white px-2 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={()=> document.getElementById("my_modal_3").showModal()}>Login</a>
                <Login/>
            </div>
        </div>
    </div>
